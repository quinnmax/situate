function [classifier_output, cnn_feature_vect] = svm_apply( classifier_struct, target_class, im, box_r0rfc0cf, varargin )
% [classifier_output, cnn_feature_vect] = svm_apply(classifier_struct, target_class, im, box_r0rfc0cf );
%
% given 
...
%   the cnn feature vector that was generated during the estimation
    ...
    [~,temp_scores] = classifier_struct.models{model_ind}.predict( cnn_feature_vect' );
    classifier_output = sigmoid(temp_scores(:,2),3,0);
