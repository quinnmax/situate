...
function conditional_dist_struct = situate_build_conditional_distribution_structure( fnames_lb, p )
    ...
    for ci = 1:length( objects_indexing_order )
        ...
        temp = box_model_train( boxes_t_xywh, boxes_a_xywh, boxes_b_xywh, boxes_c_xywh );
