function model_out = gmm_model_condition( model_in, varargin )
    ...
    for oj = setsub( 1:length(model_in.situation_objects), oi )
        ...
        model_bar = gmm_condition( model_in, want_data_inds, known_inds, known_values );
        
        
        % save it to the object_specific distribution struct
        
        model_out       = model_in;
        model_out.mu    = model_bar.mu;
        model_out.Sigma = model_bar.Sigma;
        model_out.pi    = model_bar.pi;
