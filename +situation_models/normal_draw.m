...
%         persistent old_mu_xy;
%         persistent old_Sigma_xy;
%         persistent up_to_date_obj_inds_xy;
%         
%         persistent old_mu_shape;
%         persistent old_Sigma_shape;
%         persistent up_to_date_obj_inds_shape;
%         
%         
%         persistent old_mu_size;
%         persistent old_Sigma_size;
%         persistent up_to_date_obj_inds_size;
