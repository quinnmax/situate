function h = uniform_then_normal_draw( d, object_string, what_to_draw, input_agent, box_format_arg, initial_draw  )
% h = uniform_then_normal_draw( d, object_string, what_to_draw, input_agent, format_arg, [box_r0rfc0cf], [box_format_arg], [initial_draw] );
%
