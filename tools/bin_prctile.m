function [bin_assignments,bin_edges,bin_centers,bin_means] = bin_prctile(x,input)

% [bin_assignments,bin_edges,bin_centers] = bin_prctile(x,num_bins);
% [bin_assignments,bin_edges,bin_centers] = bin_prctile(x,bin_edges);
%
...
if numel(input) == 1
    num_bins = input;
    bin_edges = prctile(x,round(linspace(0,100,num_bins+1)));
