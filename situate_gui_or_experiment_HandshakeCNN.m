    ...
    experiment_title = 'handshake_cnn2';
...
%% set up shared situate parameteres
    ...
    %p.classification_method   = 'IOU-oracle';
     p.classification_method = 'CNN-SVM';
    
    p.use_box_adjust = false;
...
switch situation
    ...
    case 'handshaking'       
        ...
        possible_paths = { ...
            ...
            '/home/rsoiffer/Desktop/HandshakeLabeled'};
        data_path = possible_paths{ find(cellfun(@(x) exist(x,'dir'),possible_paths), 1 )};
    ...
    case 'pingpong'
        ...
        possible_paths = { ...
            ...
            '/home/rsoiffer/Desktop/PingPongLabeled'};
        data_path = possible_paths{ find(cellfun(@(x) exist(x,'dir'),possible_paths), 1 )};
...
%% generate training and testing sets
    ...
    % generate training/testing splits for cross validation
        ...
        % if we don't have a testing_data_max, 
