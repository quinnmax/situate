...
% the directory with images of that situation that will be used in the run
    ...
    cur_situation.prior_object_urgency = [6 1 .1]; % Before object has been checked in 
    cur_situation.posterior_object_urgency = [.1 .1 .1]  % After object has been checked in
