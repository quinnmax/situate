function [ success, box_r0rfc0cf, box_xywh, box_xcycwh, aspect_ratio, area_ratio ] = fix_box( box, format_str, image_size )
% [ box_r0rfc0cf, box_xywh, box_xcycwh, aspect_ratio, area_ratio ] = situate.fix_box( box, format_str, image_size );
